...
fun VerificationScreen(
    ...
    OlegTheme {
        Column(
            ...
            val description = stringResource(id = R.string.we_send_verification_code_to_your_email, user.email)
            Text(
                text = description.annotatedString(SpanStyle(color = OlegColor.Violet100), user.email),
